...
The App allows users to launch the device camera, capture images, overlay text on the images, and save the edited results.
...
2. Copyright for images edited by the user belongs to the user.
3. We assume no responsibility for any image data handled through the App.
...
Any disputes related to the App shall be subject to the exclusive jurisdiction of the court having authority over the developer's location.
